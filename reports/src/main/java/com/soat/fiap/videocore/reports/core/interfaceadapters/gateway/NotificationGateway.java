...
/**
 * Gateway responsável por abstrair o envio de notificações de reportes aos clientes.
 * Atua como intermediário entre a camada de aplicação e a fonte de notificação.
 */
@Component
