...
public class GetAuthUserVideoImagesDownloadUrlUseCase {
	...
	/**
	 * Recupera a URL de download das imagens de um vídeo, enviado pelo um usuário
	 * autenticado, a partir do id da requisição e do nome do vídeo. Utiliza um
	...
	public String getVideoImagesDownloadUrl(String requestId, String videoName) {
		...
		if (userId == null || userId.isBlank())
			throw new NotAuthorizedException(
					"O ID do usuário não pode estar em branco para obtenção da URL de download do arquivo de imagens. Verifique a autenticação.");
		...
		if (downloadUrl == null || downloadUrl.isBlank())
			throw new VideoImageDownloadUrlNotFoundException(
					"URL de download do arquivo de imagens do vídeo informado não encontrada. RequestID: %s e VideoName: %s",
					requestId, videoName);
