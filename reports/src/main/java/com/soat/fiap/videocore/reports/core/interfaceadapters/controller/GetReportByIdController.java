...
/**
 * Controller responsável por orquestrar a busca de um {@link Report} pelo seu
 * identificador único.
 */
@Component @RequiredArgsConstructor
public class GetReportByIdController {
	...
	public ReportResponse getReportById(String reportId) {
		var report = getReportByIdUseCase.getReportById(reportId);
