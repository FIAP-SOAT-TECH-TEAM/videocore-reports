...
/**
 * Caso de uso responsável por buscar um reporte já existente a partir de chaves
 * de negócio.
 */
...
public class GetExistingReportUseCase {
	...
	/**
	 * Busca um {@link Report} existente pelo {@code userId}, {@code requestId},
	 * {@code videoName} e {@code percentStatusProcess}.
	 *
	 * @param userId
