...
public class CosmosDbReportFallbackRepository {
	 ...
	 *
	 * @return uma implementação vazia de {@link CosmosDbReportRepository}, para fins de
	...
	public CosmosDbReportRepository cosmosDbReportRepository() {
		return new CosmosDbReportRepository() {
            ...
            @Override
            public <S extends ReportEntity> S save(String s, PartitionKey partitionKey, Class<S> domainType, CosmosPatchOperations patchOperations) {
                return null;
            }

            @Override
            public <S extends ReportEntity> S save(String s, PartitionKey partitionKey, Class<S> domainType, CosmosPatchOperations patchOperations, CosmosPatchItemRequestOptions options) {
                return null;
            }
