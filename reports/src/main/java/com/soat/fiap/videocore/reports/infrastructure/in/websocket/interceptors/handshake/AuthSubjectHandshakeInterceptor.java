...
/**
 * Interceptor de handshake WebSocket responsável por validar e propagar o
 * header {@code
 * Auth-Subject} para os atributos da sessão.
 */
@Component @Slf4j
public class AuthSubjectHandshakeInterceptor implements HandshakeInterceptor {

	/**
	 * Valida a presença do header {@code Auth-Subject} e o armazena nos atributos
	 * do handshake.
	 *
	 * @param request
	 *            requisição HTTP do handshake
	 * @param response
	 *            resposta HTTP do handshake
	 * @param wsHandler
	 *            handler WebSocket associado
	 * @param attributes
	 *            mapa de atributos da sessão WebSocket
	 * @return {@code true} se o header estiver presente e válido; caso contrário
	 *         {@code false}
	 */
	@Override
	 ...
	 *            handler WebSocket associado
	 * @param exception
	 *            exceção ocorrida durante o handshake, se houver
	 */
	@Override
