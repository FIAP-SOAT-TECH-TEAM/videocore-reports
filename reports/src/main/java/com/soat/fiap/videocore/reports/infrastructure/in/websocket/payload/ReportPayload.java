...
/**
 * Payload que representa um reporte de atualização do status de processamento
 * de um vídeo
 *
 * @param id
 ...
 */
public record ReportPayload(String id, String videoName, String userId, String requestId, String traceId, long imageMinute,
