 ...
 *
 * <p>
 * Expõe um endpoint para conexão WebSocket e habilita um broker simples para
 * publicação/assinatura de mensagens em tópicos.
 */
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
	...
	/**
	 * Registra interceptors no canal de entrada (inbound) para validar/autorizar
	 * mensagens STOMP dos clientes.
	 *
	 * @param registration
	 *            registro do canal inbound
	 */
	@Override
	 ...
	 *
	 * @param registry
	 *            registro do broker de mensagens
	 */
	@Override
