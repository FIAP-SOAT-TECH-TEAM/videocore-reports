...
public class ReportTopicChannelInterceptor implements ChannelInterceptor {
	...
	/**
	 * Intercepta mensagens STOMP de {@link StompCommand#SUBSCRIBE}, bloqueia
	 * assinaturas quando o {@code Auth-Subject} da sessão não existe, e normaliza o
	 * destino da assinatura de acordo com o usuário autenticado.
	 *
	 * @param message
	 *            mensagem STOMP
	 * @param channel
	...
	public Message<?> preSend(Message<?> message, MessageChannel channel) {
		...
		try {
			...
			var normalizedDestination = WebSocketConstants.REPORTS_FULL_PATH_NAME + "/" + authSubject;
