...
/**
 * Objeto de domínio que representa um reporte de atualização no status de
...
public class Report {
	...
	public Report(VideoName videoName, ImageMinute imageMinute, MinuteFrameCut minuteFrameCut, Metadata metadata,
			PercentStatusProcess percentStatusProcess, Instant reportTime, ProcessStatus status) {
	 ...
	 *             se {@code id} for {@code null}
	 * @throws ReportException
	 *             se {@code id} estiver em branco
	 */
	 ...
	 *            nome do vídeo
	 * @throws NullPointerException
	 *             se {@code videoName} for {@code null}
	 */
	 ...
	 * @throws NullPointerException
	 *             se {@code imageMinute} for {@code null}
	 */
	 ...
	 *            intervalo de captura em minutos
	 * @throws NullPointerException
	 *             se {@code minuteFrameCut} for {@code null}
	 */
	 ...
	 * @throws NullPointerException
	 *             se {@code metadata} for {@code null}
	 */
	 ...
	 * @throws NullPointerException
	 *             se {@code percentStatusProcess} for {@code null}
	 */
	public void setPercentStatusProcess(PercentStatusProcess percentStatusProcess) {
		this.percentStatusProcess = Objects.requireNonNull(percentStatusProcess,
				"percentStatusProcess não pode ser nulo");
	}
	 ...
	 *            instante do reporte
	 * @throws NullPointerException
	 *             se {@code reportTime} for {@code null}
	 */
