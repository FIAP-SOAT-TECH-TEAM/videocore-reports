...
/**
 * Caso de uso responsável por atualizar um {@link Report} existente com base em
 * um novo {@link Report}.
 *
 * <p>
 * Este caso de uso aplica os valores do {@code newReport} no {@code report}
 * utilizando os setters do {@code report} e retorna a mesma instância
 * atualizada ao final.
 */
@Component
public class UpdateReportUseCase {
	 ...
	 *
	 * <p>
	 * Este método não cria uma nova instância de {@link Report}. Ele modifica o
	 * objeto recebido em {@code report} aplicando os valores do {@code newReport}
	 * através de setters.
	 *
	 * @param report
	 *            reporte existente que será atualizado
	 * @param newReport
	 *            reporte contendo os novos valores que devem ser aplicados
