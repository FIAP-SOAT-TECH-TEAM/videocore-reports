 ...
 *     ProcessVideoStatusUpdatePayload.class,
 *     ProcessVideoErrorEventDto.class
 * })
 * }
 * </pre>
 *
...
public class JacksonHints implements RuntimeHintsRegistrar {
    ...
    public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
        registerForBinding(hints, ProcessVideoStatusUpdatePayload.class);
        registerForBinding(hints, ProcessVideoErrorEventDto.class);
    }
