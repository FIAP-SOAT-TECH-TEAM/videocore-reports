 ...
 */
public record ProcessVideoStatusUpdatePayload(String videoName, String userId, String requestId, String traceId,
		long imageMinute, long frameCutMinutes, Double percentStatusProcess, Instant reportTime, boolean isError) {
}
