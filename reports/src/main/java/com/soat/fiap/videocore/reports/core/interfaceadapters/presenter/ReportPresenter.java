...
/**
 * Presenter responsável por converter objetos de domínio ({@link Report})
 * em objetos de resposta para a camada de entrada HTTP ({@link ReportResponse}).
 */
@Mapper(componentModel = "spring")
public interface ReportPresenter {

    /**
     * Converte um {@link Report} (domínio) para {@link ReportResponse} (DTO de saída HTTP).
     *
