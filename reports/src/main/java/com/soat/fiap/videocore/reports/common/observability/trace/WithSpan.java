package com.soat.fiap.videocore.reports.common.observability.trace;
 ...
 *
 * <p>Permite definir o nome do span e tags opcionais no formato
 * {@code chave=valor}. O span é criado automaticamente ao entrar no método
 * anotado e finalizado ao sair, incluindo cenários de exceção.</p>
 *
 * <p>O span criado torna-se o span atual, permitindo:</p>
 * <ul>
 *   <li>Adicionar eventos manualmente via {@code Tracer.currentSpan().event(...)}</li>
