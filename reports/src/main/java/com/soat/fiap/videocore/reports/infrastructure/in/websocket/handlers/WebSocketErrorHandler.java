...
/**
 * Handler de erros do protocolo STOMP para padronizar respostas de falha ao cliente.
 *
 * <p>Converte exceções em frames {@code ERROR} e adiciona um {@code error-code} para casos conhecidos.</p>
 */
@Component
public class WebSocketErrorHandler extends StompSubProtocolErrorHandler {

    /**
     * Trata erros durante o processamento de mensagens do cliente e devolve um frame {@code ERROR}.
     *
     * @param clientMessage mensagem original enviada pelo cliente
     * @param exception exceção lançada durante o processamento
