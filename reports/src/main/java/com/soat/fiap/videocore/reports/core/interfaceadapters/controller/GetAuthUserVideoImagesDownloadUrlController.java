...
/**
 * Controller responsável por orquestrar a recuperação da URL de download das
 * imagens capturadas de um vídeo, enviado pelo usuário autenticado.
 */
...
public class GetAuthUserVideoImagesDownloadUrlController {
	...
	/**
	 * Retorna a URL de download das imagens de um vídeo, enviado pelo usuário
	 * autenticado
	 *
	 * @param requestId
