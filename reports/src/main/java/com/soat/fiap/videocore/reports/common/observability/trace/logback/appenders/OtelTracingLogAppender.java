package com.soat.fiap.videocore.reports.common.observability.trace.logback.appenders;
...
/**
 * Appender Logback que adiciona mensagens de log como eventos no span
 * OpenTelemetry atualmente ativo.
 *
 * <p>
 * Cada log é propagado para o trace via
 * {@link io.opentelemetry.api.trace.Span#current()}, permitindo correlação
 * entre logs e traces distribuídos.
 */
