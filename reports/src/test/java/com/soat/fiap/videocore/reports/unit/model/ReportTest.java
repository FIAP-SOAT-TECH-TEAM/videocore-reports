...
class ReportTest {
	...
	void shouldThrowExceptionWhenAnyConstructorArgumentIsNull() {
		...
		assertThrows(NullPointerException.class,
				() -> new Report(ReportFixture.videoName(), ReportFixture.imageMinute(), null, ReportFixture.metadata(),
						ReportFixture.percentStatusProcess(), now, ProcessStatus.PROCESSING));
		...
		assertThrows(NullPointerException.class,
				() -> new Report(ReportFixture.videoName(), ReportFixture.imageMinute(), ReportFixture.minuteFrameCut(),
						ReportFixture.metadata(), ReportFixture.percentStatusProcess(), null,
